"""
Callbacks module compatibility layer.
...
if preferred == 'tensorflow':
    from cymetric.tensorflow.models.callbacks import *
elif preferred == 'torch':
    from cymetric.torch.models.callbacks import *
elif preferred == 'jax':
    from cymetric.jax.models.callbacks import *
else:
    raise ImportError("No framework (PyTorch, TensorFlow, or JAX) available for callbacks module")
